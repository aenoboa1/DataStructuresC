...
typedef struct  
{
	     ...
	     String artista;
             float precio;
             int canciones;
} CD; //Creando una variable global tipo CD
...
CD inputCD(){
	...
	getchar();
	fgets(myCDs.titulo,256,stdin); //Uso de fgets para obtener la entrada por teclado , sin ignorar los espacios escritos por el Usuario
